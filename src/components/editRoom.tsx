...
import { createRoom, editRoom, getSelectRoom } from '../features/rooms/roomsSlice';
...
export default function EditRoom() {
    ...
    dispatch(getSelectRoom(params.hash))
        ...
        <PageCardDetail>
            <div style={{ width: '100%', display: 'flex', flexWrap: 'wrap'}}>
                ...
                <div style={{ width: '100%'}}>
                    ...
                    <Input value='' size='16px' lineHeight='25px' margin='0 30px 30px 0' placeholder='Deluxe Z - 002424' onChange={(e: any) => {setRoomNumber(e.target.value)}}></Input>
                </div>
